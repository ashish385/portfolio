    ...
    >
      <div className="container mx-auto h-full">
        <div className="flex items-center h-full pt-8">
          <MotionOnScroll className="flex flex-1 flex-col items-center lg:items-start" delayMs={0} durationMs={600} translateY={16}>
            <p className="text-lg text-accent mb-[15px]">Hey, I'm Ashish Soni</p>
            ...
            <button className="btn btn-md bg-accent hover:bg-accent-hover rounded-md md:btn-lg transition-all duration-300 hover:translate-y-[-2px] hover:shadow-lg">
              Hire me
            </button>
          </MotionOnScroll>
